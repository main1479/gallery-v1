...
// =========================================
const initLibraryPageContentMarkup = () => {
	const libraryPageContentParent = document.querySelector('.libraryPage__content');
	const libraryPageContentMarkup = libraryPageContent
		.map((item) => {
			return `
	...
	libraryPageContentParent.innerHTML = '';
	libraryPageContentParent.insertAdjacentHTML('afterbegin', libraryPageContentMarkup);
};
